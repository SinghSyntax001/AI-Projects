...
class RelevanceAgent:
    ...
    def evaluate(self, user_query: str, metadata: dict) -> dict:
        """
        Evaluate dataset relevance based on semantic similarity.
        """
...
if __name__ == "__main__":
    ...
    query = "plant disease classification dataset"
    metadata = {
        "title": "PlantVillage",
        "description": "A dataset of plant leaf images for disease classification.",
        "url": "https://huggingface.co/datasets/plant_village",
        "source": "huggingface"
    }
    print(agent.evaluate(query, metadata))
